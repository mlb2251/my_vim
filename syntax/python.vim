...
" removed `assert` so that we can color assert lines gray
...
syn keyword mlb_states SNormal SQuote SShquote SShmode SSpacecall Overloader SInitial
syn keyword mlb_actions POP VERBATIM NONE INCOMPLETE SEMICOLONS_ONLY COMMON_ALLOWED_CHILDREN CMPOPS BINOPS UNOPS BOOLOPS COMMON_ERROR_ON
syn keyword mlb_self self 
