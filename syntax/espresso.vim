...
syn match esh /esh{\@=/
syn match amp_sh /&sh{\@=/
syn match escaped_dollar /\$[^\w]\@=/
syn match dollar_var /\$\w\+/
syn match escaped_dollar /\$\$/
syn match escaped_dollar /\$'.*'/

hi macro ctermfg=171
hi sh ctermfg=green
hi esh ctermfg=red
hi amp_sh ctermfg=81
hi dollar_var ctermfg=208
hi escaped_dollar ctermfg=red
